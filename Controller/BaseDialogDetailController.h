 ...
 */
@interface BaseDialogDetailController : UIViewController <JSQMessagesCollectionViewDataSource,JSQMessagesCollectionViewDelegateFlowLayout, UITextViewDelegate>
...
@property(nonatomic) UIView *inputToolbar;
