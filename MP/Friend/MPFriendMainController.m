//
//  MPFriendMainController.h
//
//  Created by hjc on 16/3/17.
//  Copyright © 2016年 hjc. All rights reserved.
//
#import "MPFriendMainController.h"
...
@interface MPFriendMainController ()
{
    NSArray *_friends;
...
@implementation MPFriendMainController
...
- (void)viewDidLoad {
    ...
    navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"返回" style:UIBarButtonItemStylePlain target:self action:@selector(backToPreViewController:)];
