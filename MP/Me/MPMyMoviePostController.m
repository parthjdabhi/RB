...
#import "MPMyMoviePostController.h"
...
@interface MPMyMoviePostController ()<UIScrollViewDelegate>
{
    NSArray *_postArray;
}
@end

@implementation MPMyMoviePostController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MPPostItemCell *cell = nil;
        ...
        MPMoviePost *post = [_postArray objectAtIndex:indexPath.row];
